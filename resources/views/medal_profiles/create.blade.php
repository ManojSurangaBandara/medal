...
@endif
            ...
            <div class="card mt-3">
                ...
                <div class="card-header"><i class="nav-icon fa fa fa-users nav-icon"></i> {{ __(' Add Medal Profile') }}</div>
                <div class="card-body">
                    <form action="{{ route('medal_profiles.store') }}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="reference_no" required class="form-control" id="reference_no"/>
                        </div>
                        <div class="mb-3">
