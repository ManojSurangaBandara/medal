...
class ReferenceDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<Reference> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($reference) {
                $btn = '<a href="' . route('references.edit', $reference->id) . '" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit Reference" ><i class="fa fa-pen"></i></a> ';
                $btn .= '<form  action="' . route('references.destroy', $reference->id) . '" method="POST" class="d-inline" onsubmit="return confirmDelete()" >
                            ' . csrf_field() . '
                                ' . method_field("DELETE") . '
     ...
     *
     * @return QueryBuilder<Reference>
     */
    public function query(Reference $model): QueryBuilder
    {
