...
class CountriesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addIndexColumn()
        ->addColumn('action', function ($countriesdatatable) {
            $btn = '';
            // $btn .= '<a href="'.route('countries.edit',$countriesdatatable->id).'" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit User" ><i class="fa fa-pen"></i></a> ';
            // $btn .= '<form  action="' . route('countries.destroy', $countriesdatatable->id) . '" method="POST" class="d-inline" onsubmit="return confirmDelete()" >
            // ' . csrf_field() . '
            //     ' . method_field("DELETE") . '
            ...
            // </form> </div>';
            $btn .= '<a href="'.route('countries.show', $countriesdatatable->id).'" class="btn btn-xs btn-info" data-toggle="tooltip" title="View User" ><i class="fa fa-eye"></i></a> ';
            return $btn;
        })
        ->rawColumns([ 'action']);
    }
